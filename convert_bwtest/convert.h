...
//----------------------------------------------------------
    template <typename Flo, typename StrType>
        typename std::enable_if<_detail::isString<StrType>::value
...
//-----------------------------------------------
    ...
    appendTo(StrType& str, Int val) {
        if (val) {
            uint8_t digit = _detail::countDigits((uint64_t)val);
            char buffer[21];
            buffer[digit] = '\0';
            uint8_t ch = val % 10;
            while(val >= 10) {
...
//-------------------------------------------------
    template<typename StrType>
        typename std::enable_if<_detail::isString<StrType>::value,void>::type
...
//------------------------------------------------------
    template<typename cCharT, typename StrType>
        typename std::enable_if<
                ...
                &&_detail::isString<StrType>::value,
        void>::type
...
//----------------------------------------------------
    template <typename StrType1, typename StrType2>
        typename std::enable_if<_detail::isString<StrType1>::value
                                && _detail::isString<StrType2>::value,
        void>::type
